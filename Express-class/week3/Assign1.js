...
//Your task is to create a global middlewares (app.use) which will rate limit the requests from a user to only 5 request per second
//If a user sends more than 5 requests in a single second, the server should block them with a 404.
//User will be sending in their user id in the header as 'user-id'
//You have been given a numberOfRequestForUser object to start off with which clears every one second
